...
function TermsPage() {
  ...
  const data = [
    ...
    },
    {
      id: 1,
      title: "서비스 이용약관 동의",
      contents: "본 약관은 온라인 서비스 '공연본당'을 이용함에 있어 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.",
      required: true,
    },
    {
      id: 2,
      title: "개인정보 처리방침 동의",
      contents: "'공연본당'이 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제 18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.",
      required: true,
    },
